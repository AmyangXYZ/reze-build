...
const en = {
  ...
  sceneFile: {
    ...
    badFile: "Not a Reze Build scene file",
  },
  account: {
    label: "Account",
    comingSoon: "Accounts aren't wired up yet.",
    signIn: "Sign in",
    signOut: "Sign out",
    signInTitle: "Sign in to Reze Build",
  ...
  share: {
    ...
    title: "Publish scene",
    comingSoon: "Sharing a scene at a permanent link isn't built yet — this is a placeholder for that door.",
    publish: "Publish",
    label: "Share",
    fork: "Open in editor",
    thumbnail: "Thumbnail",
  ...
  render: {
    ...
    scriptDone: (file: string, size: string) =>
      file ? `AE script saved — ${file} · ${size}` : `AE script downloaded · ${size}`,
  ...
  lab: {
    ...
    closePmxInspector: "Close inspector",
    ...
    groups: { cast: "Model", clips: "Clips", music: "Music", scene: "Scene" },
...
const zh: Dictionary = {
  ...
  share: {
    ...
    title: "发布场景",
    comingSoon: "以永久链接分享场景的功能还没做好——这里先占个位。",
    publish: "发布",
    label: "分享",
    fork: "在编辑器中打开",
    thumbnail: "封面图",
  ...
  render: {
    ...
    scriptDone: (file: string, size: string) => (file ? `AE 脚本已保存 — ${file} · ${size}` : `AE 脚本已下载 · ${size}`),
  ...
  lab: {
    ...
    groups: { cast: "模型", clips: "片段", music: "音乐", scene: "场景" },
    rows: {
      camera: "相机",
      ground: "地面",
      stage: "环境",
