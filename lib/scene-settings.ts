...
export type SceneSettings = {
  ...
  physics: {
    /** Whether the solver runs at all.
     *
     *  A scene composer never wants this off — cloth that does not move is a
     *  scene that looks broken. A MODEL editor does: physics hides what a rig is
     *  doing, and the first thing you check when a skirt misbehaves is how it
     *  sits with the solver stopped. */
    enabled: boolean
