...
const ISSUES_URL = "https://github.com/AmyangXYZ/reze-build/issues/new"
...
const readLocale = (): "en" | "zh" => {
  try {
    const saved = window.localStorage.getItem("reze-build.locale")
...
const SCENE_KEYS = ["reze-build.sceneState.3", "reze-build.sceneAssets.1", "reze-build.fork"]
